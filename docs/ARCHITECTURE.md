...
| EDID inspection CLI | `tools/EdidInspect/EdidInspect.cpp` | Read an EDID binary file and print base identity and detailed timings | Portable Core plus standard C++ file/stream APIs | Diagnostic only; no hardware discovery or write/apply path. |
